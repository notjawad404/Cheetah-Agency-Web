...
export default function Page() {
  ...
  return (
    <div className="h-screen bg-gradient-to-r from-gray-600 to-black flex items-center justify-center">
      <div className="p-8 rounded-lg text-center text-white max-w-lg">
        ...
        {selectedOption === null && (
          <p className="text-red-500 mb-4">Please select one</p>
        )}
        ...
        <div className="flex justify-between mt-4">
          ...
          <button
            className={`py-2 px-6 rounded-full flex flex-row items-center ${
              selectedOption
                ? "bg-lime-500 text-gray-900 hover:bg-lime-600"
